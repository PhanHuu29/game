...
export function useSound() {
  ...
  const link_nhac_nen = './sounds/nhac-nen.mp3'; 
  const link_chon_mon = './sounds/nhac_bo_chon.mp3'; 
  const link_bo_chon  = './sounds/nhac_chon_mon.mp3'; 
  const link_dung_roi = ''; 
  const link_sai_roi  = '';
  const link_chien_thang = './sounds/nhacchienthang.mp3'; 
